    ...
    <section className="display-result">
      <div className="display-result__content">
        ...
        <p className="display-result__text">
          ...
          building responsive, accessible, and user-focused websites and applications. I bring
          designs to life using modern technologies such as React, TypeScript, and SCSS while
          following a mobile-first approach and accessibility guidelines.
          <br />
